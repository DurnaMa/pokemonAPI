...
function pokemonCard() {
    ...
    for (let pokemonIndex = 0; pokemonIndex < fetchPokemons.length; pokemonIndex++) {
        ...
        <div onclick="openPokemonCard(${pokemonIndex})" class="cursor-pointer mb-3 flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
...
function openPokemonCard(pokemonIndex) {
        ...
        <div class="flex-auto  max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <img onclick="closePokemonCard()" class="cursor-pointer w-8 h-8 items-end justify-end flex" src="./assets/icons/square-x_1.png">
